...
define( 'NEWSLETTER_CAMPAIGN_KIT_VERSION', '0.21.1' );
...
require_once NEWSLETTER_CAMPAIGN_KIT_DIR . 'inc/post-campaigns.php';
require_once NEWSLETTER_CAMPAIGN_KIT_DIR . 'inc/native-providers.php';
