	...
	<div class="wrap newsletter-campaign-kit-admin">
		...
		<dialog id="nck-template-editor" class="nck-admin-dialog"<?php echo $editing ? ' data-nck-dialog-auto-open' : ''; ?>>
			...
			<form method="POST" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="nck-form">
				...
				<div class="nck-editor-field"><label for="nck-template-html"><?php esc_html_e( 'Visual email content', 'newsletter-campaign-kit' ); ?></label><textarea id="nck-template-html" class="large-text" name="template_html_body" rows="14" data-nck-rich-editor><?php echo esc_textarea( $form['html_body'] ); ?></textarea></div>
